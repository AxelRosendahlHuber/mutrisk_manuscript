# pre-process chemotherapy-exposed blood mutations
...
output_blood_preprocessed = "processed_data/blood/processed_blood_chemotherapy/"
...
# load files"
clone_files = list.files("raw_data/blood/blood_chemotherapy/", pattern  = "annotated_mut_set", recursive = TRUE, full.names = TRUE)
...
for (file in clone_files) {
  ...
  fwrite(mutlist_sample, paste0("processed_data/blood/processed_blood_chemotherapy/", name, "_sample_mutations.txt.gz"))
